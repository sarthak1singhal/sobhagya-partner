            ...
            <div className="shadow-sm">
                <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
                    <div className='flex justify-center items-center gap-2 '>
                        ...
                        <span className='text-xl font-bold'>SOBHAGYA</span>
                    </div>
                    <div className="flex items-center space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2 justify-end">
                        ...
                        <div className="dropdown flex shrink-0">
                            <Dropdown
                                ...
                                button={<img className="h-9 w-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src={userData?.avatar} alt="userProfile" />}
                            >
                                <ul className="w-[230px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                                    <li>
                                        <div className="flex items-center px-4 py-4">
                                            <img className="h-10 w-10 rounded-md object-cover" src={userData?.avatar} alt="userProfile" />
                                            <div className="truncate ltr:pl-4 rtl:pr-4">
                                                <h4 className="text-base">
                                                    {userData?.name}
                                                    {
                                                        userData?.status=="offline"?
                                                    <span className="rounded bg-danger-light px-1 text-xs text-danger ltr:ml-2 rtl:ml-2">{userData?.status}</span>
                                                        :
                                                    <span className="rounded bg-success-light px-1 text-xs text-success ltr:ml-2 rtl:ml-2">{userData?.status}</span>
